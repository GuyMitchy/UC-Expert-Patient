...
class ChatModelTests(TestCase):
    ...
    def test_conversation_creation(self):
        ...
        self.assertEqual(str(self.conversation), 
    ...
    def test_message_creation(self):
        ...
        self.assertEqual(str(self.message), 
                       f"User: Hello, this is a test message...")
    ...
    def test_conversation_get_absolute_url(self):
        ...
        expected_url = reverse('chat:detail', kwargs={'pk': self.conversation.pk})
...
class ChatViewTests(TestCase):
    def setUp(self):
        ...
        self.send_message_url = reverse('chat:send_message', args=[self.conversation.pk])

    def test_login_required(self):
        """Test all views require login"""
        urls = [self.list_url, self.create_url, self.detail_url, 
               self.delete_url, self.send_message_url]
    ...
    def test_create_conversation(self):
        ...
        self.assertTrue("I'm your UC Expert assistant" in welcome_message.content)
